  ...
  return (
    <>
      <div className="flex justify-between items-center">
        <div className="bg-gray-200 px-3 py-1 flex items-center justify-between gap-x-2 rounded-full w-[75%]">
        ...
        <div className="flex justify-between items-center w-[25%] text-sm px-6">
          ...
          <button className="border border-gray-300 p-1.5 rounded-md text-gray-700 font-medium shadow-2xl">Submit an image</button>
        </div>
      </div>
